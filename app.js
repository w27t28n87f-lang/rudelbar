...
function creatorUIRendern(){
  ...
  document.querySelectorAll("[data-cprod]").forEach(b=>b.onclick=()=>{creatorState.produkt=b.dataset.cprod;creatorState.x=0;creatorState.y=0;creatorState.angle=0;creatorUIRendern();creatorZeichnen();});
