...
let creatorState={produkt:"hoodie",farbe:"#111111",groesse:"M",view:"front",bg:"dark",scale:1,x:0,y:0,rot:0,flipX:1,flipY:1};
...
function creatorZeichnen(){
  ...
  creatorBg(ctx,w,h);creatorKleidungsstueck(ctx,w,h);
  if(creatorImg){
